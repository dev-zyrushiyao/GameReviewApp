...
<div id="sticky-header">
	<div id="header-flexbox">
		...
		<form action="/search/" method="GET">
			...
			<label>Account Level: <span id="user-role">Administrator</span></label>
			<br>
				...
				<c:when test="${genreValueSession == null && platformValueSession == null}">
						<c:forEach var="listOfGames" items="${gameList}">
								 ...
								 <ul>
						      		...
						      		<li><a href="admin/view/game/info/id/${listOfGames.getId()}"><img src="${listOfGames.getImageUrl()}"></a></li>
